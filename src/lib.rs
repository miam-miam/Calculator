...
mod tests {
    ...
    fn number_parse() {
        assert_eq!(
            ...
            Ok(BasicToken::Integer(i128::MAX))
        );
        assert_eq!(
            eval(
            ...
            Ok(BasicToken::Double(i128::MAX as f64 + 1_f64))
        );
        assert_eq!(
            eval(Expression::parse(Rule::calculation, "+5").unwrap()),
            Ok(BasicToken::Integer(5))
        );
        assert_eq!(
            eval(Expression::parse(Rule::calculation, "-5").unwrap()),
            Ok(BasicToken::Integer(-5))
    ...
    fn e_parse() {
        ...
        assert_eq!(
            ...
            Ok(BasicToken::Double((i128::MAX as f64 + 1_f64) * 100_f64))
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            Ok(BasicToken::fraction(0, 11, 20))
        );
        assert_eq!(
            eval(Expression::parse(Rule::calculation, "-5.5e+1").unwrap()),
            Ok(BasicToken::Integer(-55))
        );
        assert_eq!(
            eval(Expression::parse(Rule::calculation, "-595.524e-1").unwrap()),
            Ok(BasicToken::fraction(-59, -1381, 2500))
        );
        assert_eq!(
